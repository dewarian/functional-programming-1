// Thank you Wouter en Daniël van de Velde
...
module.exports = class OBAWrapper {
	...
	async get (endpoint, options) {
		...
		const results = [];
		let page = 1;
		// options.count is the maximum results you want to request, so it always needs to be the max and 
		// results.length can only go till you reach the max. count.
